        ...
        var _dialog = function (options) {
            ...
            var html = alr.html().replace(reg, function (node, key) {
                return {
                    ...
                    MessagerIcon: '<img class="messagerIcon" src="images/' + ops.iconImg + '.png">'
                }[key];
            });
            alr.html(html);
            alr.modal({
